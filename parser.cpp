        ...
        vector<Token> tokenize() {
            ...
            while (pos < src.size()) {
                ...
                switch (current) {
                        ...
                        default: cout << "Unexpected character at line " << current<<"at line: "<<line<< endl; exit(1);
                }
                pos++;
            }
...
private:
    ...
    void parseStatement() {
        if (tokens[pos].type == T_INT) {
            ...
            cout << "Syntax error on line " << tokens[pos].line<<"Unexpected Error"<<tokens[pos].value << endl;
            exit(1);
        }
    }
